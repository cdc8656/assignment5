...
//IMPORT STYLE
import styles from './assignment5_styles.module.css'; // Example path
...
function AirlineRoutes(){
    ...
    return <Container >
        ...
        <Col lg={4}>
            <h2>Airlines</h2>
            <svg className={styles.svgStyle} width={barchart_width} height={barchart_height}>
        ...
        <Col lg={4} >
            <h2>Airports</h2>
            <svg className={styles.svgStyle} width={map_width} height={map_height}>
